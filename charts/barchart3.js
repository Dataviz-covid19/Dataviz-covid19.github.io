function drawChart_a1_v3() {
  ...
  let margin = { top: 60, right: 30, bottom: 100, left: 330 };
  let width = 500;
  let height = 400;
  ...
  d3.csv("../../data/data_barchart_wafflechart_piechart.csv").then(function (
    ...
    g.append("g")
      ...
      .text(
        "Comparing Total Vaccinations among Top 20 countries using Bar chart"
      );
    ...
    g.selectAll(".bar")
      ...
      .attr("height", function (d) {
        return height - yScale(d.Total_Vaccinations);
      });
  ...
  function onMouseOver(d, i) {
    ...
    d3.select(this)
      ...
      .attr("y", function (d) {
        return yScale(d.Total_Vaccinations) - 10;
      })
      .attr("height", function (d) {
        return height - yScale(d.Total_Vaccinations) + 10;
      });
  }
